...
def gethpuxapp():
    ...
    cl = ['PHCO_40381', 'PHCO_41479', 'PHKL_38038', 'PHKL_38938', 'PHKL_39351', 'PHSS_36354', 'PHSS_37042',
          'PHSS_37959', 'PHSS_39094', 'PHSS_39100', 'PHSS_39102', 'PHSS_38141', 'PHSS_39824', 'PHKL_40941']
    for x in cl:
        cmd = "/usr/sbin/swlist -l patch | grep " + x
    ...
    if vs > 0:
        score += 1
        fres.append(dict(rkey="系统软件包检查", rval="\n".join(str(i) for i in vt), rtype=1, rnote="系统软件包检查不合规"))
    else:
        fres.append(dict(rkey="系统软件包检查", rval="软件包检查通过", rtype=0, rnote="系统软件包检查合规"))
