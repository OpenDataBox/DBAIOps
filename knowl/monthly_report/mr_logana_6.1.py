...
'''.format(rpt_id, targetid, begintime, endtime)
        ...
        if logdbinfonote:
            ...
            ismf = '''
begin;
delete from rpt_finding where rpt_id='{0}' and target_id='{1}' and rpt_finding_module='db_start_shutdown';
...
select '{0}' rpt_id,'{1}' target_id,1 rpt_finding_id,'db_start_shutdown' rpt_finding_module,
