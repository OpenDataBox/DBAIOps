...
""" + logswitchnote
            ismf = '''
begin;
delete from rpt_finding where rpt_id='{0}' and target_id='{1}' and rpt_finding_module='log_history_ri';
...
select '{0}' rpt_id,'{1}' target_id,1 rpt_finding_id,'log_history_ri' rpt_finding_module,
